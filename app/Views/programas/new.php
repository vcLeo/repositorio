...
<form class="row g-3" method="post" action="<?= base_url('programas'); ?>" autocomplete="off">

    <?= csrf_field(); ?>

    <div class="col-md-4">
        <label for="nombre_programa" class="form-label"><span class="text-danger">*</span> Nombre programa</label>
        <input type="text" class="form-control" id="nombre_programa" name="nombre_programa" value="<?= set_value('nombre_programa'); ?>" required
            autofocus>
    </div>
    <div class="col-md-4">
        <label for="version" class="form-label"><span class="text-danger">*</span> Version</label>
        <input type="text" class="form-control" id="version" name="version" value="<?= set_value('version'); ?>"
            required autofocus>
    </div>
    <div class="col-md-6">
        ...
        <select class="form-select" id="id_tipo_programa" name="id_tipo_programa" required>
            ...
            <?php foreach ($tipo_programa as $tipo) : ?>
                ...
                <option value="<?= $tipo['id']; ?>"><?= $tipo['nombre_tipo_programa']; ?></option>
